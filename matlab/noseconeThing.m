function noseconeThing(L, D, d_shoulder, L_shoulder, saveName, outType)
	% NOSECONETHING  Create a nosecone?
	%  noseconeThing(L, D, d_shoulder, L_shoulder, saveName, outType)
	% 
	...
	%
	%  Future Improvements:
	% * Add wall thickness and density to calculate approximate mass
	% 
